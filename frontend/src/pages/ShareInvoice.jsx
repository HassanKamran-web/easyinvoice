...
const ShareInvoice = () => {
    ...
    useEffect(() => {
        const fetchInvoice = async () => {
            try {
                const res = await axios.get(`${import.meta.env.VITE_BASE_URL}/api/invoice/get/${id}`);
    ...
    return (
        <div className="min-h-screen bg-slate-950 text-white p-4 md:p-10">
            <div className="bg-gray-950/60 fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 text-white backdrop-blur-sm">
